...
/**
 * The persistent class for the TPAGARE_MAESTRO_LIQUIDACIONPRE database table.
 * 
 */
@Entity
@Table(name="TPAGARE_MAESTRO_LIQUIDACIONPRE")
@NamedQuery(name="TpagareMaestroLiquidacionpre.findAll", query="SELECT t FROM TpagareMaestroLiquidacionpre t")
public class TpagareMaestroLiquidacionpre implements Serializable {
	private static final long serialVersionUID = 1L;
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEC_MALIPRE")
	@SequenceGenerator(name = "SEC_MALIPRE", sequenceName = "", allocationSize = 1)
	@Id
	@Column(name="ID_MALI")
	...
	public TpagareMaestroLiquidacionpre() {
	}
