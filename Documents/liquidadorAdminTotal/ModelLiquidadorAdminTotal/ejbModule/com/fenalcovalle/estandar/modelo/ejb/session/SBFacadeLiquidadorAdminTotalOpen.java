...
@Stateless(name = "SBFacadeLiquidadorAdminTotalOpen")
public class SBFacadeLiquidadorAdminTotalOpen implements  SBFacadeLiquidadorAdminTotalOpenLocal {
    @PersistenceContext(unitName = "open")
    private EntityManager emSBFacade;

    public SBFacadeLiquidadorAdminTotalOpen() {
    }
