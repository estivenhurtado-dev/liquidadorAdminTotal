...
@Stateless(name = "SBFacadeCarteraAfiliadosAS400")
public class SBFacadeLiquidadorAdminTotalAS400 implements  SBFacadeLiquidadorAdminTotalAS400Local {
    @PersistenceContext(unitName = "AS400")
    private EntityManager emSBFacade;

    public SBFacadeLiquidadorAdminTotalAS400() {
    }
