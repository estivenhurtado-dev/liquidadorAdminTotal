...
function validarCaracteres(str) {
    var validos = " 1234567890abcdefghijklmnñopqrstuvwxyzABCDEFGHIJKLMNÑOPQRSTUVWXYZ&'.()-_#%\/";
...
function validarClave(str) {
    var validos = "1234567890abcdefghijklmnñopqrstuvwxyzABCDEFGHIJKLMNÑOPQRSTUVWXYZáéíóúÁÉÍÓÚ ";
    for (var i = 0;i < str.length;i++) {
        if (validos.indexOf(str.charAt(i)) ==  - 1)
            return true;
    }
...
//Método que permite Quitar los espacios en blanco a los lados en las formas que tiene campos de tipo texto
...
//Método que permite saber en un combo se selecciono una opcion si es -1 no se selecciono
//Hecho Por Diego Gomez diegomez@jvsoftware.com
...
/* 
* Metodo para validar si una cadena númerica tipo flotante es positiva
* Elaborado por Jorge Hernán Vélez Modificada por Alejandro Alvarez, para validar que sea flotante.
*/
...
function ValidaForma() {
    ...
    clearFormSpace();
    transformToUpperCase();//transforma los campos a mayúsculas,jmduran@jvsoftware.com
        ...
        if (val) {
            ...
            if ((val = val.value) != "") {
                ...
                if (test.indexOf('isEmail') !=  - 1) {
                    ...
                    if (bandera == false) {
                        errors += '- ' + nm + ' debe ser una fecha válida entre el año 1700 y 2300.\n';
                    }
                }
                    ...
                    if (bandera == false) {
                        errors += '- ' + nm + ' no tiene un formato válido.\n';
                    }
                }
                ...
                else if (test.indexOf('isMoney') !=  - 1)//valida si el formato es moneda
                {
                    ...
                    if (bandera == false) {
                        errors += '- ' + nm + ' debe ser un formato de moneda válido.\n';
                    }
                }
                ...
                else if (test.indexOf('isLetter') !=  - 1)//JD
                {
                    ...
                    if (swcheck == 0) {
                        errors += '- ' + nm + ' requiere seleccionar una opción.\n';
                    }
                }
                else if (test.indexOf('isCombo') !=  - 1) {
                    if (val == "-1")
                        errors += '- ' + nm + ' no se seleccionó.\n';

                }
                else if (test.indexOf('isEspecial') !=  - 1 || test.indexOf('isNotNum') !=  - 1) {
                    if (test.indexOf('isEspecial') !=  - 1) {
                        if (!validarCaracteres(val))
                            errors += '- ' + nm + ' contiene caracteres con tildes o caracteres no válidos .\n';
                    }

                    if (test.indexOf('isNotNum') !=  - 1) {
                        num = parseFloat(val);
                        if (!isNaN(num))
                            errors += '- ' + nm + ' NO debe contener solo números.\n';
                    }
                    ...
                    if (!isNumericIntPositivo(val))
                        errors += '- ' + nm + ' debe ser número entero positivo.\n';
                }
                else if (test.indexOf('isInteger') !=  - 1) {
                    if (!validarEnteros(val))
                        errors += '- ' + nm + ' debe contener números enteros.\n';
                }
                else if (test.indexOf('isPositive') !=  - 1) {
                    if (!isNumericPositivo(val))
                        errors += '- ' + nm + ' debe contener números positivos.\n';
                }
                    ...
                    if (isNumeric(val)) {
                        ...
                        else if (punto !=  - 1)// si vienen decimales validamos que traiga la cantidad correcta
                        {
                            ...
                            if (parteEntera.length > enteros) {
                                errors += '- ' + nm + ' debe contener un máximo de ' + enteros + ' digitos enteros y ' + decimales + ' decimales.\n';
                            }
                        }
                        ...
                        errors += '- ' + nm + ' debe ser un número con un máximo de ' + enteros + ' digitos enteros y ' + decimales + ' decimales.\n';
                }
                else if (test != 'R') {
                    num = parseFloat(val);
                    if (isNaN(val))
                        errors += '- ' + nm + ' debe contener solo números.\n';
...
// ------------------------------------------------------------------
function isDate(val) {
    //si no recibe el formato lo toma de la variable global formato.Nota: Debe inicializarse esta variablñe a través del metodo setFormat
    // Modificado por Alejandro Alvarez para validar que las fechas validas esten unicamente entre el año 1900 y 2200.
...
//Método que permite deshabilitar o habilitar todos campos de tipo texto de una forma
...
//Función que transforma los datos en Mayúsculas a aquellos campos que tengan la clase SnowInput, al resto no les hace nada
...
if (parent == null)
    document.title = "Fenalco Valle ::: Preliquidación Educativa";//si es una pagina sola
else if (parent.parent != null)
    parent.parent.document.title = "Fenalco Valle ::: Preliquidación Educativa";//si es una página dentro de 2 frames
else 
    parent.document.title = "Fenalco Valle ::: Preliquidación Educativa";//si es una página dentro de 1 frame
...
//Realizado Por luis alberto Bolaños
...
function formateafecha(obj) {
    ...
    if ((long >= 5) && (segundoslap == false)) {
        ...
        //Validacion de Dias por mes sin tomar en cuenta año
        if (num == 2) {
            diasMes = 29;
        }
        else {
