...
if (parent == null)
    document.title = "Fenalco Valle ::: Sistema FC Solicitues";//si es una pagina sola
else if (parent.parent != null)
    parent.parent.document.title = "Fenalco Valle ::: Sistema FC Solicitues";//si es una p�gina dentro de 2 frames
else 
    parent.document.title = "Fenalco Valle ::: Sistema FC Solicitues";//si es una p�gina dentro de 1 frame
