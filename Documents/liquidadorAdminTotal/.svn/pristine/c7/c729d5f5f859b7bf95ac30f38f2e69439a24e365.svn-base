...
public class CargarArchivosPropiedadesUtil {
    ...
    public String getProperty(String fileName, String propertyName) throws Exception {
        ...
        try {
            pro = new Properties();
            InputStream input = 
                Thread.currentThread().getContextClassLoader().getResourceAsStream("com/fenalcovalle/estandar/vista/properties/" + fileName);
            pro.load(input);
    ...
    public List getListProperty(String fileName, String propertyName, 
        ...
        try {
            pro = new Properties();
            InputStream input = 
                Thread.currentThread().getContextClassLoader().getResourceAsStream("com/fenalcovalle/estandar/vista/properties/" + 
                                                                                   fileName);
            pro.load(input);
