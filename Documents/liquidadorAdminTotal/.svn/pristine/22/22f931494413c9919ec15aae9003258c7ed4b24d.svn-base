...
@Stateless(name = "SBFacadeLiquidadorAdminTotal")
public class SBFacadeLiquidadorAdminTotal implements  SBFacadeLiquidadorAdminTotalLocal {
    @PersistenceContext(unitName = "fena")
    private EntityManager emSBFacade;

    public SBFacadeLiquidadorAdminTotal() {
    }
