 ...
 */
@Entity
@Table(name="TPAGARE_DETALLE_LIQUIDACION")
@NamedQuery(name="TpagareDetalleLiquidacion.findAll", query="SELECT t FROM TpagareDetalleLiquidacion t")
public class TpagareDetalleLiquidacion implements Serializable {
	...
	public TpagareDetalleLiquidacion() {
	}
