...
@Stateless(name = "SBFacadeConsolaLiquidadorAdminTotal")
public class SBFacadeConsolaLiquidadorAdminTotal implements SBFacadeConsolaLiquidarorAdminTotalLocal {
    @PersistenceContext(unitName = "Consola")
    private EntityManager emSBFacade;

    public SBFacadeConsolaLiquidadorAdminTotal() {
    }
